...
class BaseModelTestCase(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.doctor_one = Doctors(email="Saqnjeev@gmail.com", name="Sanjeev Rathore", city= "Lucknow",	state= "Uttar Pradesh",	zipcode= "204101")
        cls.doctor_one.save()
        cls.doctor_two = Doctors(email="tarun@gmail.com", name="Tarun", city= "Lucknow", state= "Uttar Pradesh", zipcode= "204101")
        cls.doctor_two.save()
        cls.patient_one = Patients(email="tarun@gmail.com", name="Tarun", city= "Lucknow",	state= "Uttar Pradesh",	zipcode= "204101")
        cls.patient_one.save()
        cls.patient_two = Patients(email="Saqnjeev@gmail.com", name="Sanjeev Rathore", city= "Lucknow",	state= "Uttar Pradesh",	zipcode= "204101")
...
class PatientFailModelTestCase(TestCase):
    ...
    def test_fail_patient_insertion_two(self):
        ...
        patient_fail=Patients(email="Saqnjeev@gmail.com", name="Sanjeev Rathore", city= "Lucknow",	state= "Uttar Pradesh")
        patient_fail.save()
